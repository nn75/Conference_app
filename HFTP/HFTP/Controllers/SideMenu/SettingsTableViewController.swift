...
class SettingsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        avatorView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector( handleSelectProfileImageView)))
    }
    ...
    func setUpFields(){
        ...
        if(!myUser.avator.isEmpty) {
            avatorView.image = fetchData.stringToImage(myUser.avator)
        } else {
            avatorView.image = UIImage(named: K.imageName.defaultPhoto)
        }
    }
